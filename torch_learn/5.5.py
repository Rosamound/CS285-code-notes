...
# 1. train on returned distributions
...
plt.savefig('demo6-2.png', dpi=300, bbox_inches='tight')
...
# plt.legend()
plt.title("losses")
plt.savefig('demo7-2.png', dpi=300, bbox_inches='tight')
...
plt.legend()
plt.savefig('demo8-2.png', dpi=300, bbox_inches='tight')
...
plt.legend()
plt.savefig('demo9-2.png', dpi=300, bbox_inches='tight')
